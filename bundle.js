...
window.initMapHelper = function () {
  let map = new __WEBPACK_IMPORTED_MODULE_0__components_googlemaps__["a" /* LC_GoogleMaps */]('exampleMap', {
      zoom: 2,
  });
  // map.init();
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LC_GoogleMaps; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__maphelper__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__maphelper___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__maphelper__);
...
class LC_GoogleMaps {
    constructor(elm = null, options = {}) {
        let defaults =  {
            ...
            map: {},
            settings: {
                zoom: (__WEBPACK_IMPORTED_MODULE_0__maphelper___default.a.mobilecheck()) ? 10 : 11,
                scrollwheel: false,
                disableDefaultUI: true,
                center: new google.maps.LatLng(0, 0),
                styles: __WEBPACK_IMPORTED_MODULE_0__maphelper___default.a.styles
            },
            markers: [ //Dummy Data
                {
                    lat: 38.1406578,
...
// }
    ...
    setMarkers(search = null, reset = false, overview) {
        ...
        this.state.markers.forEach((data, index) => {
            ...
            let icon = __WEBPACK_IMPORTED_MODULE_0__maphelper___default.a.icons.default;

            let marker = new google.maps.Marker({
                position:  new google.maps.LatLng( parseFloat(data.lat),parseFloat(data.long) ),
                icon: {
                    url: icon,
                    size: new google.maps.Size(__WEBPACK_IMPORTED_MODULE_0__maphelper___default.a.markerSize, __WEBPACK_IMPORTED_MODULE_0__maphelper___default.a.markerSize)
                },
